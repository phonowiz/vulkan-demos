...
*/
    ...
    void createGraphicsPipeline() {
        ...
        readFile(vertShaderCode, vertShader);
        std::string fragShaderCode;
        std::string fragShader = baseDir + "shaders/triangle.frag";
        readFile(fragShaderCode, fragShader);
        
        VkPipelineShaderStageCreateInfo vertShaderStageInfo = {};
        VkPipelineShaderStageCreateInfo fragShaderStageInfo = {};
        
        init_shaders(device, vertShaderStageInfo, VK_SHADER_STAGE_VERTEX_BIT, vertShaderCode);
        init_shaders(device, fragShaderStageInfo, VK_SHADER_STAGE_FRAGMENT_BIT, fragShaderCode);
