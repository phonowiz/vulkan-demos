...
public:
    ...
    virtual void init_node() override
    {
        ...
        vk::resource_set<vk::render_texture>& luminance =  _tex_registry->get_read_render_texture_set("final_render", this, vk::usage_type::INPUT_ATTACHMENT);

        vk::attachment_group<LUMINANCE_ATTACHMENTS>& luminance_attachment_grp = pass.get_attachment_group();
       
        luminance_attachment_grp.add_attachment( _swapchain->present_textures, glm::vec4(0.0f));
       

        luminance_subpass.set_image_sampler(luminance, "luminance", vk::parameter_stage::FRAGMENT, 0, vk::usage_type::COMBINED_IMAGE_SAMPLER);
        luminance_subpass.add_output_attachment("present");
